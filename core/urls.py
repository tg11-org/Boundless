...
urlpatterns = [
    ...
    path("profile/parental-controls/", views.parental_controls, name="parental_controls"),
    path("profile/guardian-settings/", views.guardian_settings, name="guardian_settings"),
    path("verify-guardian/<str:token>/", views.verify_guardian_email, name="verify_guardian_email"),
